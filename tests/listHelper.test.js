...
describe('totalLikes', () => {
    ...
    test('when list only has one blog equals the likes of that', () => {
        ...
        const newResult = listHelper.totalLikes(blog1);
    ...
    test('of a bigger list is calculated right', () => {
        ...
        const manyResult = listHelper.totalLikes(manyBlogs);
        expect(manyResult).toBe(36);
    });
...
describe('favorite blog', () => {
    test('returns blog with the most likes', () => {
        ...
        const favResult = listHelper.favoriteBlog(moreBlogs);
